...
//    }()
//    
//    var pipPosition: PIPPosition = .topCenter
...
//        //Farooq
//        case .topCenter:
//            origin.x = 10//window.frame.width - safeAreaInsets.right - Consts.hangAroundPadding - pipSize.width
//            origin.y = safeAreaInsets.top + Consts.hangAroundPadding
//            
//            
//        case .middleCenter:
...
//        
//        let vh = (window.frame.height - (safeAreaInsets.top + safeAreaInsets.bottom)) / 3.0
//        if pipPosition == .topCenter || pipPosition == .bottomCenter || pipPosition == .middleCenter{
//            switch center.y {
//            case let y where y < safeAreaInsets.top + vh:
//                pipPosition = /*center.x < window.frame.width / 2.0 ? .topCenter :*/ .topCenter
//            case let y where y > window.frame.height - safeAreaInsets.bottom - vh:
//                pipPosition = /*center.x < window.frame.width / 2.0 ? .topCenter :*/ .bottomCenter
//            default:
//                pipPosition = /*center.x < window.frame.width / 2.0 ? .topCenter :*/ .middleCenter
//            }
//        } else {
//            switch center.y {
//            case let y where y < safeAreaInsets.top + vh:
